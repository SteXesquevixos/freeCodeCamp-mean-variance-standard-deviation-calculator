...
class UnitTests(unittest.TestCase):
    def test_calculate(self):
        actual = any(mean_var_std.calculate([2, 6, 2, 8, 4, 0, 1, 5, 7]))
        expected = any({
    ...
    def test_calculate2(self):
        actual = any(mean_var_std.calculate([9, 1, 5, 3, 3, 3, 2, 9, 0]))
        expected = any({'mean': [[4.666666666666667, 4.333333333333333, 2.6666666666666665], [5.0, 3.0, 3.6666666666666665],
                             3.888888888888889],
